...
export function DonationForm() {
  ...
  return (
    <div className="bg-gray-50 p-6 rounded-lg border border-[#CCCCCC]">
      <div className="flex items-center justify-between mb-6">
        <h3 className="text-xl font-semibold font-nunito">Help us do more</h3>
      ...
      <div className="mb-6">
        <p className="text-gray-700 mb-3">Make your donation</p>
      ...
      <div className="mb-6">
        <h3 className="text-lg font-semibold mb-2">Who's giving today?</h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
          ...
          <div>
            ...
            <div className="flex mt-1">
              <div className="flex items-center border rounded-l px-3 bg-gray-50 text-gray-500">
