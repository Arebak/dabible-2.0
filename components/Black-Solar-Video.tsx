  ...
  return (
       <div className="bg-black w-full">
          <div className="text-center pt-18 mb-12">
            ...
            <p className="text-white text-sm md:text-lg max-w-2xl mx-auto mt-4 font-mada">
...
export default BlackSolarVideo;